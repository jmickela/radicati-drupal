...
namespace Drupal\radicati_views_addons\Plugin\views\style;
 ...
 *
 * @ViewsStyle(
 *   id = "views_radicati_columns",
 *   title = @Translation("Radicati Columns"),
 *   help = @Translation("Displays rows in a columnar layout"),
 *   theme="views-radicati-columns",
 *   display_types = {"normal"}
 * )
 */
class ViewsRadicatiColumns extends StylePluginBase {
  /**
...
//  }
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    // This is in bootstrap grid, I don't think we need this, but leaving it here just in case.
//    $form['alignment'] = [
//      '#type' => 'radios',
